            ...
            <div class="fcpfw_container" >
                ...
                echo FCPFW_comman();
                            ...
                            <div class='fcpfw_total_tr_inner'>
                                ...
                                <?php  if ($fcpfw_comman['fcpfw_discount_show_cart']== "yes" ) { ?>
                                    ...
                                    if(($fcpfw_cart_discount) != 0) {   ?>
                                        <div class="fcpfw_discount_label">
                                             <span><?php echo esc_attr($fcpfw_comman['fcpfw_discount_text_trans']); ?></span>
                                        </div>
                                ...
                                <?php  if ($fcpfw_comman['fcpfw_total_all_option'] == "yes" ) { ?>
                                    <div class="fcpfw_oc_total_oc">
                                        <div class="fcpfw_total_label">
                                             <span><?php echo esc_attr($fcpfw_comman['fcpfw_apply_total_text']); ?></span>
                                        </div>
                                        <div class="fcpfw_total_innwer_full">
                                            <span class='fcpfw_fragtotall_full'><?php echo get_woocommerce_currency_symbol().number_format(WC()->cart->total, 2); ?></span>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
                                            ...
                                            ?>
                                                <div class="item fcpfw_gift_product">
                                                    <a href="<?php echo esc_url(get_permalink( $productc->get_id() )); ?>">
                                                        ...
                                                        <div class="fcpfw_left_div"><?php echo $productc->get_image();// phpcs:ignore WordPress.Security.EscapeOutput ?></div>
                                                        <div class="fcpfw_right_div">
                                                            <h3 style="color: <?php echo esc_attr($fcpfw_comman['fcpfw_sld_product_ft_clr']); ?>;font-size: <?php echo esc_attr($fcpfw_comman['fcpfw_sld_product_ft_size']); ?>px;"><?php echo esc_attr($title); ?></h3>
                                                            <span style="color: <?php echo esc_attr($fcpfw_comman['fcpfw_sld_product_ft_clr']); ?>;font-size: <?php echo esc_attr($fcpfw_comman[ 'fcpfw_sld_product_ft_size']); ?>px;"><?php echo wc_price($price); ?></span>

                                                            <?php

                                                            if ($productc->get_type() == 'simple') {
                                                                echo "<a href='?add-to-cart=".esc_attr($value)."' data-quantity='1' class='fcpfw_pslide_atc' data-product_id='".esc_attr($value)."' style='background-color: ".esc_attr($fcpfw_comman['fcpfw_ft_btn_clr'])."; color: ".esc_attr($fcpfw_comman[ 'fcpfw_ft_btn_txt_clr']).";'>".esc_attr($fcpfw_comman[ 'fcpfw_slider_vwoptbtn_txt'])."</a>";
                                                            } elseif ($productc->get_type() == 'variable' ) {
                                                                echo "<a href='".esc_url(get_permalink($value))."' data-quantity='1' class='fcpfw_pslide_prodpage' data-product_id='".esc_attr($value)."' style='background-color: ".esc_attr($fcpfw_comman[ 'fcpfw_ft_btn_clr'])."; color: ".esc_attr($fcpfw_comman[ 'fcpfw_ft_btn_txt_clr']).";'>".esc_attr($fcpfw_comman[ 'fcpfw_slider_vwoptbtn_txt'])."</a>";
                                                            } elseif ($productc->get_type() == 'variation') {
                                                                $prod_id = $productc->get_parent_id();
                                                                echo "<a href='?add-to-cart=".esc_attr($value)."' data-quantity='1' class='fcpfw_pslide_atc' data-product_id='".esc_attr($prod_id)."' variation-id='".esc_attr($value)."' style='background-color: ".esc_attr($fcpfw_comman[ 'fcpfw_ft_btn_clr'])."; color: ".esc_attr($fcpfw_comman['fcpfw_ft_btn_txt_clr' ]).";'>".esc_attr($fcpfw_comman['fcpfw_slider_vwoptbtn_txt'])."</a>";
                                                            }
                                                            ?>
                                                        </div>
                                                    </a>
                    ...
                    ?>
                        ...
                        <?php  if($fcpfw_comman['fcpfw_prodslider_desktop'] == 'yes') { ?>
                    ...
                    if(!empty($productsa)) {
                        ...
                        foreach ($productsa as $value) {
                            ...
                            if(!empty($productc)){
                                ...
                                if (!empty($cart_product_ids) && !in_array($value, $cart_product_ids)) {
                                    ...
                                    <div class="item fcpfw_gift_product">
                                        ...
                                        <a href="<?php echo get_permalink( $productc->get_id() ); ?>">
                                                ...
                                                <div class="fcpfw_right_div">
                                                    ...
                                                    if ($productc->get_type() == 'simple') {
                                                        echo "<a href='?add-to-cart=".esc_attr($value)."' data-quantity='1' class='fcpfw_pslide_atc' data-product_id='".esc_attr($value)."' style='background-color: ".esc_attr($fcpfw_comman['fcpfw_ft_btn_clr'])."; color: ".esc_attr($fcpfw_comman[ 'fcpfw_ft_btn_txt_clr']).";'>".esc_attr($fcpfw_comman['fcpfw_slider_atcbtn_txt'])."</a>";
                                                    } elseif ($productc->get_type() == 'variable' ) {
                                                        echo "<a href='".esc_url(get_permalink($value))."' data-quantity='1' class='fcpfw_pslide_prodpage' data-product_id='".esc_attr($value)."' style='background-color: ".esc_attr($fcpfw_comman[ 'fcpfw_ft_btn_clr'])."; color: ".esc_attr($fcpfw_comman[ 'fcpfw_ft_btn_txt_clr']).";'>".esc_attr($fcpfw_comman['fcpfw_slider_vwoptbtn_txt'])."</a>";
                                                    } elseif ($productc->get_type() == 'variation') {
                                                        $prod_id = $productc->get_parent_id();
                                                        echo "<a href='?add-to-cart=".esc_attr($value)."' data-quantity='1' class='fcpfw_pslide_atc' data-product_id='".esc_attr($prod_id)."' variation-id='".esc_attr($value)."' style='background-color: ".esc_attr($fcpfw_comman[ 'fcpfw_ft_btn_clr'])."; color: ".esc_attr($fcpfw_comman[ 'fcpfw_ft_btn_txt_clr']).";'>".esc_attr($fcpfw_comman[ 'fcpfw_slider_atcbtn_txt'])."</a>";
