                        ...
                        <div class="inside">
                            <table class="data_table">
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" class="fcpfw_all_pages" name="fcpfw_comman[fcpfw_all_pages]" value="yes" <?php if($fcpfw_comman['fcpfw_all_pages'] == 'yes'){echo "checked";}?>>
                                ...
                                <tr class="fcpfw_single_pages">
                                    ...
                                    <td class="scpfw_visibility_on_pages">
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_display_home_page]" value="yes" <?php if($fcpfw_comman['fcpfw_display_home_page'] == 'yes'){ echo "checked";}?>>
                                        <label><?php echo __('Display On Home Page','floating-cart-product-for-woocommerce');?></label></br>

                                        <input type="checkbox" class="fcpfw_display_shop_page" name="fcpfw_comman[fcpfw_display_shop_page]" value="yes" <?php if($fcpfw_comman['fcpfw_display_shop_page'] == 'yes'){ echo "checked";}?>>
                                        <label><?php echo __('Display On Shop Page','floating-cart-product-for-woocommerce');?></label></br>

                                        <input type="checkbox" class="fcpfw_display_product_page" name="fcpfw_comman[fcpfw_display_product_page]" value="yes" <?php if($fcpfw_comman['fcpfw_display_product_page'] == 'yes'){ echo "checked";}?>>
                                        <label><?php echo __('Display On Single Product Page','floating-cart-product-for-woocommerce');?></label></br>

                                        <input type="checkbox" name="fcpfw_comman[fcpfw_display_cart_page]" value="yes" <?php if($fcpfw_comman['fcpfw_display_cart_page'] == 'yes'){ echo "checked";}?>>
                                        <label><?php echo __('Display On Cart Page','floating-cart-product-for-woocommerce');?></label></br>

                                        <input type="checkbox" name="fcpfw_comman[fcpfw_display_checkout_page]" value="yes" <?php if($fcpfw_comman['fcpfw_display_checkout_page'] == 'yes'){ echo "checked";}?>>
                                        <label><?php echo __('Display On Checkout Page','floating-cart-product-for-woocommerce');?></label></br>

                                        <input type="checkbox" name="fcpfw_comman[product_cat_page]" value="yes" <?php if($fcpfw_comman['product_cat_page'] == 'yes'){echo "checked";}?>>
                                        <label><?php echo __('Product Category Page','floating-cart-product-for-woocommerce');?></label><br>

                                        <input type="checkbox" name="fcpfw_comman[product_tag_page]" value="yes" <?php if($fcpfw_comman['product_tag_page'] == 'yes'){echo "checked";}?>>
                                        <label><?php echo __('Product Tag Page','floating-cart-product-for-woocommerce');?></label>
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <table class="data_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <strong><?php echo __('Basket Icon','floating-cart-product-for-woocommerce');?></strong>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="inside">
                            <table class="data_table">
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_total_shipping_option]" value="yes" <?php if ($fcpfw_comman['fcpfw_total_shipping_option'] == "yes" ) { echo 'checked="checked"'; } ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_discount_show_cart]" value="yes" <?php if ($fcpfw_comman['fcpfw_discount_show_cart'] == "yes" ) { echo 'checked="checked"'; } ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_total_tax_option]" value="yes" <?php if ($fcpfw_comman['fcpfw_total_tax_option'] == "yes" ) { echo 'checked="checked"'; } ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_total_all_option]" value="yes" <?php if ($fcpfw_comman['fcpfw_total_all_option'] == "yes" ) { echo 'checked="checked"'; } ?>>
                        ...
                        <div class="inside">
                            <table class="data_table">
                                 <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_prodslider_desktop]" value="yes" <?php if ($fcpfw_comman['fcpfw_prodslider_desktop'] == "yes" ) { echo 'checked="checked"'; } ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_prodslider_mobile]" value="yes" <?php if ($fcpfw_comman['fcpfw_prodslider_mobile'] == "yes" ) { echo 'checked="checked"'; } ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="fcpfw_select_product" name="fcpfw_select2[]" multiple="multiple" style="width:100%;max-width:15em;">
                                            <?php 
                         ...
                         <div class="inside">
                            <table class="data_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_cart_empty]" value="yes" <?php if ($fcpfw_comman['fcpfw_cart_empty'] == "yes" ) { echo 'checked="checked"'; } ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_show_cart_icn]" value="yes" <?php if ($fcpfw_comman['fcpfw_show_cart_icn'] == "yes" ) { echo 'checked="checked"'; } ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="fcpfw_comman[fcpfw_cart_check_page]" value="yes" <?php if ($fcpfw_comman['fcpfw_cart_check_page'] == "yes" ) { echo 'checked="checked"'; } ?>>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="fcpfw_comman[fcpfw_on_pages]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_on_pages']); ?>">
                        ...
                        <div class="inside">
                            <table class="data_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_head_ft_clr']);?>" name="fcpfw_comman[fcpfw_head_ft_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_head_ft_clr']);?>"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_header_cart_icon_clr']); ?>" name="fcpfw_comman[fcpfw_header_cart_icon_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_header_cart_icon_clr']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_header_close_icon_clr']); ?>" name="fcpfw_comman[fcpfw_header_close_icon_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_header_close_icon_clr']); ?>"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_header_shipping_text_color']); ?>" name="fcpfw_comman[fcpfw_header_shipping_text_color]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_header_shipping_text_color']); ?>"/>
                                    </td>
                                </tr>
                        ...
                        <div class="inside">
                            <table class="data_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_product_ft_clr']); ?>" name="fcpfw_comman[fcpfw_product_ft_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_product_ft_clr']); ?>"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="inside">
                            <table class="data_table">
                                <tr>
                                    ...
                                    <td>
                                        <select name="fcpfw_comman[fcpfw_cart_empty_hide_show]">
                        ...
                        <div class="inside">
                            <table class="data_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_delect_icon_clr']); ?>" name="fcpfw_comman[fcpfw_delect_icon_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_delect_icon_clr']); ?>"/>
                                    </td>
                                </tr>
                                 <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_apply_cpn_icon_clr']); ?>" name="fcpfw_comman[fcpfw_apply_cpn_icon_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_apply_cpn_icon_clr']); ?>"/>
                                    </td>
                                </tr> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_apply_cpn_ft_clr']); ?>" name="fcpfw_comman[fcpfw_apply_cpn_ft_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_apply_cpn_ft_clr']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php echo __('Apply Button Text Color','floating-cart-product-for-woocommerce');?></th>
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_applybtn_cpn_ft_clr']); ?>" name="fcpfw_comman[fcpfw_applybtn_cpn_ft_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_applybtn_cpn_ft_clr']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php echo __('Apply Button Background Color','floating-cart-product-for-woocommerce');?></th>
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_applybtn_cpn_bg_clr']); ?>" name="fcpfw_comman[fcpfw_applybtn_cpn_bg_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_applybtn_cpn_bg_clr']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_sld_product_ft_clr']); ?>" name="fcpfw_comman[fcpfw_sld_product_ft_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_sld_product_ft_clr']); ?>"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="inside">
                            <table class="data_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" name="fcpfw_ship_ft_size" value="<?php echo esc_attr($fcpfw_comman['fcpfw_ship_ft_size']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php echo __('Shipping Text Font Color','floating-cart-product-for-woocommerce');?></th>
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_ship_ft_clr']); ?>" name="fcpfw_comman[fcpfw_ship_ft_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_ship_ft_clr']); ?>"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="inside">
                            <table class="data_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_ft_btn_clr']); ?>" name="fcpfw_comman[fcpfw_ft_btn_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_ft_btn_clr']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php echo __('Footer Buttons Text Color','floating-cart-product-for-woocommerce');?></th>
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_ft_btn_txt_clr']); ?>" name="fcpfw_ft_btn_txt_clr" value="<?php echo esc_attr($fcpfw_comman['fcpfw_ft_btn_txt_clr']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="inside">
                             <table class="data_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_basket_bg_clr']); ?>" name="fcpfw_comman[fcpfw_basket_bg_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_basket_bg_clr']); ?>"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_basket_clr']); ?>" name="fcpfw_comman[fcpfw_basket_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_basket_clr']); ?>"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_cnt_bg_clr']); ?>" name="fcpfw_comman[fcpfw_cnt_bg_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_cnt_bg_clr']); ?>"/>
                                    </td>
                                </tr> 
                                <tr>
                                    <th><?php echo __('Count Text Color','floating-cart-product-for-woocommerce');?></th>
                                    <td>
                                        <input type="text" class="color-picker" data-alpha="true" data-default-color="<?php echo esc_attr($fcpfw_comman['fcpfw_cnt_txt_clr']); ?>" name="fcpfw_comman[fcpfw_cnt_txt_clr]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_cnt_txt_clr']); ?>"/>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="inside">
                            <table class="data_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="fcpfw_comman[fcpfw_slider_atcbtn_txt]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_slider_atcbtn_txt']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php echo __('View Options Button Text','floating-cart-product-for-woocommerce');?></th>
                                    <td>
                                        <input type="text" name="fcpfw_comman[fcpfw_slider_vwoptbtn_txt]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_slider_vwoptbtn_txt']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="fcpfw_comman[fcpfw_shipping_text_trans]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_shipping_text_trans']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php echo __('Tax','floating-cart-product-for-woocommerce');?></th>
                                    <td>
                                        <input type="text" name="fcpfw_comman[fcpfw_apply_taxt_testx]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_apply_taxt_testx']); ?>">
                                    </td>
                                </tr>
                                 <tr>
                                    <th><?php echo __('Discount Text','floating-cart-product-for-woocommerce');?></th>
                                    <td>
                                        <input type="text" name="fcpfw_comman[fcpfw_discount_text_trans]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_discount_text_trans']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th><?php echo __('Total','floating-cart-product-for-woocommerce');?></th>
                                    <td>
                                        <input type="text" name="fcpfw_comman[fcpfw_apply_total_text]" value="<?php echo esc_attr($fcpfw_comman['fcpfw_apply_total_text']); ?>">
                                    </td>
                                </tr>
            ...
            if(!isset( $_POST['fcpfw_nonce_field'] ) || !wp_verify_nonce( $_POST['fcpfw_nonce_field'], 'fcpfw_nonce_action' ) ){
                ...
                if(!empty($_REQUEST['fcpfw_comman'])){
                    $isecheckbox = array(
                        ...
                        'fcpfw_ajax_cart',
                        'fcpfw_qty_box',
                        'fcpfw_total_shipping_option',
                        'fcpfw_discount_show_cart',
                        'fcpfw_total_tax_option',
                        'fcpfw_total_all_option',
                        'fcpfw_cart_option',
                        'fcpfw_checkout_option',
                        'fcpfw_conshipping_option',
                        'fcpfw_coupon_field_mobile',
                        'fcpfw_prodslider_desktop',
                        'fcpfw_prodslider_mobile',
                        'fcpfw_show_cart_icn',
                        'fcpfw_cart_check_page',
                        'fcpfw_mobile',
                        'fcpfw_product_cnt',
                        'fcpfw_cart_empty',
                        'fcpfw_all_pages',
